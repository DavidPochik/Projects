...
import math
import sys
pythonpath=str(sys.argv[6])
sys.path.insert(0, pythonpath)
import athena_read

FILE_name_f = "accretion.prim."+sys.argv[2]+".athdf"
FILE_name_g = "accretion.uov."+sys.argv[2]+".athdf"
IC_name     = 'Lnu_'+sys.argv[1]+'e51_Mdot_'+sys.argv[3]+'_RPNS_'+sys.argv[4]+'km_MPNS_'+sys.argv[5]+'.txt'
f_data = FILE_name_f
g_data = FILE_name_g
