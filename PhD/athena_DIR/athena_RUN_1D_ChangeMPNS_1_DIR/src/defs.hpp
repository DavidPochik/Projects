...
// problem generator
#define PROBLEM_GENERATOR "accretion_SingleNR_FixedKappa_MPNS"
...
#define COMPILED_WITH_OPTIONS " -I/apps/hdf5/intel/18.0/mvapich2/2.3/1.10.2/include -O3 -std=c++11  -L/apps/hdf5/intel/18.0/mvapich2/2.3/1.10.2/lib  -lhdf5" // NOLINT
